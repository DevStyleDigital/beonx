...
export const CookieConfirmation = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setHiddenToast(true);
    }, 1 * 60 * 1000); // set the delay here (in milliseconds)
        ...
        >
          <div className="bg-gray-700 text-white px-4 py-3 rounded shadow-md">
            <div className="flex justify-between items-center">
              <div className="mr-2">
                <p className="text-sm">
                  We use cookies to enhance your experience on our website and for
                  internal purposes such as website performance analysis and optimization.
                </p>
              </div>
              <div>
                <button
